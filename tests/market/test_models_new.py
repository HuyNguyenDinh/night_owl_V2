...
#         temp_product = business_product.make()
#         self.assertEqual(temp_product, Product.objects.last())
#     def create_negative_sold_amount_product(self) -> None:
#         self.assertRaise(IntegrityError, business_product.make, sold_amount=-1)
#
...
#         temp_option = business_product_option.make()
...
#         temp_cart = valid_cart_detail.make()
#         self.assertEqual(temp_cart, CartDetail.objects.last())
#
...
#     def create_valid_order(self) -> None:
#         temp_order = valid_order.make()
#         self.assertEqual(temp_order, Order.objects.last())
#
...
#     def create_valid_order_detail(self) -> None:
#         temp_order_detail = valid_order_detail.make()
#         self.assertEqual(temp_order_detail, OrderDetail.objects.last())
#
...
#         self.create_valid_order_detail()
#
# class IBillRecipeModelTest(ITestCase):
#     def create_general_bill(self) -> None:
#         self.assertRaise(ValidationError, general_bill.make)
#     def create_valid_bill(self) -> None:
#         temp_bill = valid_bill.make()
#         self.assertEqual(temp_bill, Bill.objects.last())
#
