...
#
# class UserViewSetTest(APITestCase, IGetCurrentUser, ICreateUser):
#     @classmethod
#     def setUpTestData(cls):
#         # cls.user = user_huy.make()
#         cls.user = User.objects.create(email="huyn2731@gmail.com", phone_number="093746132", email_verified=True,
...
#     def post_products(self, post_cloudinary_mock):
...
#
#     @patch('cloudinary.uploader.upload')
#     def put_product(self, post_cloudinary_mock):
#         post_cloudinary_mock.return_value = cloudinary_sameple_response
#         self.client.force_authenticate(user=self.users[0])
#         with open(os.path.abspath(f'%s/tests/test_img.jpeg' % settings.BASE_DIR), "rb") as image_file:
#             encoded_string = base64.b64encode(image_file.read()).decode()
...
#         self.assertEqual(response.status_code, status.HTTP_200_OK)
#
#     def add_comment_without_buying_product(self):
#         self.client.force_authenticate(user=self.users[0])
#         data = {
#             "rate": 4,
#             "comment": "Test"
...
#
#     def add_comment_valid(self) -> None:
...
#
#     @patch('cloudinary.uploader.upload')
#     def add_option(self, post_cloudinary_mock):
#         post_cloudinary_mock.return_value = cloudinary_sameple_response
#         self.client.force_authenticate(user=self.users[0])
#         with open(os.path.abspath(f'%s/tests/test_img.jpeg' % settings.BASE_DIR), "rb") as image_file:
#             encoded_string = base64.b64encode(image_file.read()).decode()
...
#         self.add_comment_without_buying_product()
#
#     def test_add_comment_valid(self) -> None:
#         self.add_comment_valid()
#
...
#         self.product_statistic_in_year()
#
#     def test_products_statistic_count_in_month(self):
#         self.products_statistic_count_in_month()
#
#     def test_product_statistic_in_month(self):
#         self.product_statistic_in_month()
